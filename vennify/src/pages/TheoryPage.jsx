  ...
  return (
    <div className="min-h-screen font-sans transition-colors duration-300 bg-gray-900 text-white">
      ...
      <div className="relative z-10">
        {/* Navigation */}
        <nav className="fixed top-0 left-0 right-0 z-50 transition-all duration-700 ease-in-out ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-4'} bg-gray-800/80 backdrop-blur-sm shadow-sm">
